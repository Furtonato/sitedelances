	...
	// Tabela Redes
		if(isset($_POST['exportar_tabela_redes']) and $_POST['exportar_tabela_redes']){
			...
			$html .= '<table style="width:100%;" border="0" cellspacing="3" cellpadding="3"> ';
				$html .= '<tr> ';
					$html .= '<td style="width: 1px" > <img src="../../web/fotos/thumbnails/'.$ex[0].'_100x100.'.$ex[1].'" style="height: 50px;" /> </td> ';
...
//exit();
	...
	require_once("../../plugins/Exportacoes/pdf/dompdf_config.inc.php");
