...
/**
 *
 * Classe para manipulaÃ§Ã£o de imagens utilizando a extensÃ£o GD
 * e recursos avanÃ§ados de filtros. Requer PHP 5 ou superior.
 *
...
class Canvas
{
    ...
    /**
     * VariÃ¡veis para armazenamento de arquivos/imgs
     * */
    private $origem, $img, $img_temp;

    /**
     * Armazenam as dimensÃµes da imagem atual e da nova imagem caso exista
     * */
    private $largura, $altura, $nova_largura, $nova_altura, $tamanho_html;

    /**
     * VariÃ¡veis para o posicionamento do crop
     * */
    private $pos_x, $pos_y;

    /**
     * InformaÃ§Ãµes sobre o arquivo enviado e diretÃ³rio
     * */
    ...
    /**
     * MÃ©todo singleton para que apenas uma instancia da classe seja utilizada no servidor.
     * @param String $origem
     * @return canvas
     */
    ...
    /**
     * Reseta variÃ¡veis para poder reutilizar objeto em encadeamentos longos
     * @return void
     * */
    ...
    private function dados()
    {
        ...
        if (is_file($this->origem)) {
            ...
            if (!$this->eImagem()) {
                trigger_error('Erro: Arquivo ' . $this->origem . ' nÃ£o Ã© uma imagem!', E_USER_ERROR);
            } else {
                // busca dimensÃµes da imagem enviada
                $this->dimensoes();
            ...
            trigger_error('Erro: Arquivo de imagem nÃ£o encontrado!', E_USER_ERROR);
        }
    }
     ...
     * @return Object instÃ¢ncia atual do objeto, para mÃ©todos encadeados
     * */
     ...
     * OBS: depente das configuraÃ§Ãµes do servidor para acesso remoto de arquivos
     * @param String $url endereÃ§o da imagem
     * @return Object instÃ¢ncia atual do objeto, para mÃ©todos encadeados
     * */
     ...
     * @param String $tipo mÃ©todo para redimensionamento (padrÃ£o [vazio], preenchimento ou crop)
     * @return Object instÃ¢ncia atual do objeto, para mÃ©todos encadeados
     * */
    ...
    /**
     * Redimensiona imagem, modo padrÃ£o, sem crop ou preenchimento
     ...
     * do crop na imagem.
     * Coordenadas Inteligentes implementado por Aires GonÃ§alves <contato@airesgoncalves.com.br>
     * @return void
     * */
    ...
    public function legenda($texto, $tamanho = 5, $x = 0, $y = 0, $cor_fundo = '', $truetype = false, $fonte = '')
    {
        ...
        /**
         * Define tamanho da legenda para posiÃ§Ãµes fixas e fundo da legenda
         * */
        if ($truetype === true) {
    ...
    /**
     * Calcula a posiÃ§Ã£o da legenda de acordo com string passada via parÃ¢metro
     *
     * @param String $posicao valores prÃ©-definidos (topo_esquerda, meio_centro etc.)
     ...
     * @param Int/String $x posiÃ§Ã£o x da marca na imagem ou constante para marcaFixa()
     * @param Int/Sring $y posiÃ§Ã£o y da marca na imagem ou constante para marcaFixa()
        ...
        if ($imagem) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'bmp':
                    ...
                    break;
                default:
                    trigger_error('Arquivo de marca d\'Ã¡gua invÃ¡lido.', E_USER_ERROR);
                    return false;
            }
        } else {
            return false;
     ...
     * @param Integer $quantidade nÃºmero de vezes que o filtro deve ser aplicado
     *            utilizado em blur, edge, emboss, pixel e rascunho
     * @param $arg1, $arg2 e $arg3 - ver manual da funÃ§Ã£o imagefilter
     * @return Object instÃ¢ncia atual do objeto, para mÃ©todos encadeados
     * */
    ...
    public function grava($destino = '', $qualidade = 100)
    {
        ...
        if ($destino) {
            ...
            if (!is_dir($dir_destino)) {
                trigger_error('DiretÃ³rio de destino inválido ou inexistente', E_USER_ERROR);
            }
        }
